...
export class NodeInfoIcon extends Icon {
  ...
  protected onDraw(canvas: Canvas2D) {
    ...
    canvas.strokeRect(
      this.parent.size.x,
      -NodeInfoIcon.HALF_ICON_SIZE,
      this.parent.size.x + this.padding.left + this.padding.right,
    ...
    canvas
      ...
      .translate(
        this.parent.size.x + this.padding.left - NodeInfoIcon.HALF_ICON_SIZE,
        -NodeInfoIcon.HALF_ICON_SIZE + this.padding.top,
      )
