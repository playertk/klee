  ...
  protected onDraw(canvas: Canvas2D) {
    this.entries.forEach((entry) => {
      canvas // Draw background box
        .roundedRectangle(
          entry.x,
          0 - Constants.DEFAULT_BOX_HEIGHT / 2,
          entry.boxWidth,
          Constants.DEFAULT_BOX_HEIGHT,
          Constants.DEFAULT_BOX_RADIUS,
        )
      ...
      canvas // Draw key label
        ...
        .fillText(
          `${entry.key}`,
          entry.x + Constants.DEFAULT_VALUE_BOX_TEXT_PADDING,
          Constants.DEFAULT_VALUE_BOX_TEXT_PADDING,
        )
      ...
      canvas // Draw value
        ...
        .fillText(
          `${entry.value}`,
          entry.x + entry.keyWidth + Constants.DEFAULT_VALUE_BOX_TEXT_PADDING,
          Constants.DEFAULT_VALUE_BOX_TEXT_PADDING,
        )
    })
  }
